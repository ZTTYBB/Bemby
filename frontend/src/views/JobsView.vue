        ...
        <template v-if="form.jobType === 'custom'">
          ...
          <div v-if="!form.templateId" class="form-group">
            ...
            <div v-for="(action, i) in customActions" :key="i" class="custom-action-card">
              ...
              <!-- open_mini_app -->
              <div v-if="action.type === 'open_mini_app'" class="custom-action-params">
                <div class="form-group" style="margin-bottom:0">
...
type CustomActionForm = {
  type: 'send_command' | 'send_contact_message' | 'wait_reply' | 'delay' | 'click_button' | 'click_message_button' | 'enter_captcha' | 'join_group' | 'subscribe_channel' | 'open_mini_app' | 'open_url';
  content: string;
